    ...
    try {
      ...
      if (data?.user) {
        ...
        if (profile?.status === "inactive") {
          ...
          throw new Error("আপনার অ্যাকাউন্টটি বর্তমানে ইন-একটিভ আছে। এডমিনের সাথে যোগাযোগ করুন।");
        }
        ...
        <div className="relative z-10 max-w-md text-center space-y-8">
          ...
          <div className="mx-auto w-20 h-20 rounded-[24px] bg-gradient-to-br from-blue-500 to-indigo-600 flex items-center justify-center shadow-2xl shadow-blue-500/30">
            <svg width="40" height="40" viewBox="0 0 40 40" fill="none">
              <rect x="6" y="4" width="20" height="26" rx="3" fill="white" fillOpacity="0.15" stroke="white" strokeWidth="1.5"/>
              <rect x="14" y="4" width="20" height="26" rx="3" fill="white" fillOpacity="0.25" stroke="white" strokeWidth="1.5"/>
              <line x1="18" y1="12" x2="30" y2="12" stroke="white" strokeWidth="1.5" strokeLinecap="round"/>
              <line x1="18" y1="17" x2="30" y2="17" stroke="white" strokeWidth="1.5" strokeLinecap="round"/>
              <line x1="18" y1="22" x2="26" y2="22" stroke="white" strokeWidth="1.5" strokeLinecap="round"/>
            </svg>
          </div>
          ...
          <div className="space-y-3">
            ...
            <p className="text-gray-400 text-lg font-medium leading-relaxed">
              Simple, fast, and flawless<br />ebook processing — every time.
            </p>
          </div>

          {/* Feature pills */}
          <div className="flex flex-wrap gap-2 justify-center">
            {["Split & Clean", "Cover Inject", "Metadata Edit", "MozJPEG Quality"].map((f) => (
              <span
                key={f}
          ...
          <div className="lg:hidden flex items-center gap-3 mb-2">
            <div className="w-10 h-10 rounded-xl bg-blue-600 flex items-center justify-center">
              <svg width="22" height="22" viewBox="0 0 40 40" fill="none">
                <rect x="6" y="4" width="20" height="26" rx="3" fill="white" fillOpacity="0.3" stroke="white" strokeWidth="2"/>
                <rect x="14" y="4" width="20" height="26" rx="3" fill="white" fillOpacity="0.5" stroke="white" strokeWidth="2"/>
              </svg>
            </div>
            <span className="font-black text-gray-900 text-lg tracking-tight">EPUB Studio</span>
          </div>

          {/* Heading */}
          <div className="space-y-1">
            <h2 className="text-2xl font-black text-gray-900 tracking-tight">Login to your account</h2>
            <p className="text-sm text-gray-400 font-medium">Enter your credentials to continue</p>
          </div>
