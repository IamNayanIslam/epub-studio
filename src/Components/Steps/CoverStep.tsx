...
const CoverStep = () => {
  ...
  const bgPreviewColor =
    coverConfig.logoColor === "white" ? "#4b9dd3" : "#ffffff";
      ...
      <div className="hidden md:flex flex-col gap-6 h-full">
          ...
          <div className="flex gap-2">
            {(["blue", "white"] as const).map((color) => (
              <button
                ...
                className={`flex-1 ${controlBtn(coverConfig.logoColor === color)}`}
              >
          ...
          <div className="flex gap-2">
            {[
              ...
              <button
                ...
                className={`flex-1 ${posBtn(coverConfig.logoPosition === pos.id)}`}
              >
        ...
        <div>
          <label className="flex items-center gap-3 cursor-pointer group">
            <div
              onClick={() =>
                updateConfig({ addBackground: !coverConfig.addBackground })
              }
