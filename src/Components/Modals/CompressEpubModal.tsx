...
export const CompressEpubModal = ({ isOpen, onClose, theme: t, isDark }: Props) => {
  ...
  return (
    <div className="fixed inset-0 z-[110] flex items-center justify-center p-4">
      ...
      <div className={`${t.card} border ${t.cardBorder} w-full max-w-lg rounded-[32px] shadow-2xl z-10 overflow-hidden`}>
        ...
        <div className="relative p-8 pb-5">
          ...
          <div className="flex flex-col items-center text-center">
            <div className="w-16 h-16 rounded-[22px] flex items-center justify-center mb-4 bg-orange-500/10 text-orange-500">
              <FileArchive size={30} />
            </div>
            <h2 className={`text-2xl font-black tracking-tight ${t.textPrimary}`}>Compress EPUB</h2>
