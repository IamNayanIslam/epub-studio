...
export const AddUserModal = ({
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-end sm:items-center justify-center p-0 sm:p-4">
      ...
      <div
        className={`${t.card} border ${t.cardBorder} w-full max-w-[480px] rounded-t-3xl sm:rounded-[28px] shadow-2xl z-10 overflow-hidden`}
      >
        {/* Header */}
        <div className="relative p-6 sm:p-8 pb-4">
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <h2
              className={`text-2xl font-black tracking-tight ${t.textPrimary}`}
            >
              Add New User
            </h2>
            <p
        ...
        <form
          ...
          className="px-5 sm:px-8 pb-6 sm:pb-8 pt-2 space-y-4"
        >
          {/* Full Name */}
          <div className="space-y-1.5">
            <label
              className={`text-[10px] font-black uppercase tracking-widest ml-1 ${t.textMuted}`}
            >
              Full Name
            </label>
            <div className="relative">
              <User
                className={`absolute left-4 top-1/2 -translate-y-1/2 ${t.textMuted}`}
                size={18}
              />
              <input
                type="text"
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <ChevronDown
                  size={14}
                  className={`absolute right-4 top-1/2 -translate-y-1/2 pointer-events-none ${t.textMuted}`}
                />
              </div>
            </div>
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                <Lock
                  className={`absolute left-3 top-1/2 -translate-y-1/2 ${t.textMuted}`}
                  size={15}
                />
                <input
                  type="text"
                  ...
                  className={`w-full pl-9 pr-16 py-3.5 rounded-2xl border ${t.cardBorder} ${t.card} ${t.textPrimary} outline-none focus:ring-2 focus:ring-blue-500/30 transition-all font-mono text-[10px] font-bold`}
                />
                <div className="absolute right-2 top-1/2 -translate-y-1/2 flex items-center gap-0.5">
                  <button
                    ...
                    className={`p-1.5 rounded-lg transition-all ${copied ? "text-emerald-500 bg-emerald-500/10" : "text-slate-400 hover:bg-blue-500/10 hover:text-blue-500"}`}
                    title="Copy Password"
                  >
