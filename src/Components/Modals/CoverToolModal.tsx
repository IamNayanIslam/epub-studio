...
export const CoverToolModal = ({ isOpen, onClose, theme: t, isDark }: Props) => {
  ...
  return (
    <div className="fixed inset-0 z-[110] flex flex-col">
      ...
      {/* ── Header bar ── */}
      <div className={`${t.header} border-b ${t.cardBorder} px-6 py-4 flex items-center justify-between shrink-0 z-10`}>
        <div>
      ...
      <div className={`flex flex-1 overflow-hidden ${t.bg}`}>
          ...
          >
            ...
            {previewUrl ? (
              <div className="relative w-full h-full group">
                ...
                {/* Logo overlay preview — pixel perfect */}
                <div
        ...
        <div className={`w-72 shrink-0 flex flex-col border-l ${t.cardBorder} ${t.card} overflow-y-auto`}>
          <div className="p-5 space-y-5 flex-1">
            ...
            {/* Logo Style */}
            <div>
              <label className={`block text-[10px] font-black ${t.textMuted} mb-2.5 uppercase tracking-[0.2em]`}>
                Logo Style
              </label>
