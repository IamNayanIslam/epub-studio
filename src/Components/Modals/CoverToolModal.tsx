...
export const CoverToolModal = ({
  ...
  return (
    <div className="fixed inset-0 z-[110] flex flex-col">
      {/* Header */}
      <div
        className={`${t.header} border-b ${t.cardBorder} px-6 py-4 flex items-center justify-between shrink-0`}
      >
        <div>
          <h2 className={`text-base font-black ${t.textPrimary}`}>
            Cover Generator
          </h2>
          <p
      ...
      <div className={`flex flex-1 overflow-hidden ${t.bg}`}>
        ...
        <div className="flex-1 flex flex-col items-center justify-center p-6 overflow-auto">
          ...
          >
            ...
            {previewUrl ? (
              ...
              <div className="w-full h-full flex flex-col items-center justify-center gap-4">
                <div
                  className={`w-16 h-16 rounded-2xl ${isDark ? "bg-[#252836]" : "bg-blue-50"} flex items-center justify-center`}
                >
          ...
          <p
            className={`mt-3 text-[10px] font-bold ${t.textMuted} uppercase tracking-widest`}
          >
        ...
        {/* Controls */}
        <div
          className={`w-72 shrink-0 flex flex-col border-l ${t.cardBorder} ${t.card} overflow-y-auto`}
        >
          <div className="p-5 space-y-5 flex-1">
            ...
            >
              ...
              >
                <strong>Cover</strong> — লোগো ছাড়া, EPUB এর জন্য
                <br />
